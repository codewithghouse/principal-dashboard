...
const TimetableSetupDesktop = (props: TimetableSetupDesktopProps) => {
  ...
  return (
    <div className="pb-10 max-w-[1400px] mx-auto px-2" style={{ fontFamily: "'DM Sans', -apple-system, sans-serif" }}>
      ...
      {/* ── Row 3: Bright stat cards 4-wide ── */}
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: "Working Days", val: `${workingDays}/6`, sub: "Days scheduled", variant: "gold" },
        ].map((s, i) => {
